      ...
      <div className={styles["desk-ap-w"]}>
        ...
        <div className={styles["product-layout-w"]}>
          <div className={styles["product-layout"]}>
            <DeskCatalog prImg={dDandy} prTitle={"The Dandy Chair"} prPrice={"250"} />
            <DeskCatalog prImg={dRustic} prTitle={"Rustic Vase Set"} prPrice={"155"} />
            <DeskCatalog prImg={dSilky} prTitle={"The Silky Vase"} prPrice={"125"} />
            <DeskCatalog prImg={dLucy} prTitle={"The Lucy Lamp"} prPrice={"399"} />
          </div>

          <div className={styles["product-layout"]}>
            <DeskCatalog prImg={dFlights} prTitle={"Falled Fl Lights"} prPrice={"840"} />
            <DeskCatalog prImg={dVase} prTitle={"Ceramic Origin"} prPrice={"435"} />
            <DeskCatalog prImg={dSm} prTitle={"Vintage Chair"} prPrice={"250"} />
            <DeskCatalog prImg={dOrangeLucy} prTitle={"Classic Orange"} prPrice={"750"} />
          </div>
