            ...
            <div className={styles["desk-ct-w"]}>
              ...
              <div className={styles["desk-ct-1"]}>
                <img
                  ...
                  className={styles["desk-ct-1-ic"]}
                />
                <h2 className={styles["desk-ct-1-sb"]}>
            ...
            <div className={styles["desk-l-5"]}>
              <div className={styles["desk-ct-5-c"]}>
                ...
                <p className={styles["desk-ct-5-pr-1"]}>
                  ...
                  we live,
                  <br /> breathe and design so our Chelsea boutique become the
                  hotbed for the <br /> London interior design community.
                </p>
              </div>

              <div className={styles["desk-ct-5-btn-c"]}>
                <button className={styles["desk-ct-5-button"]}>
                  Get in touch
                </button>
              </div>
            </div>
