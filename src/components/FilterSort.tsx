...
export interface FilterSortProps {
  ...
  categories: string[]; // Pass categories from parent (Test)
  brands: string[]; // Pass brands from parent (Test)
  sortOptions: string[]; // Pass sort options from parent (Test)
}
...
export default function FilterSort({
  ...
  return (
    <>
      {/* Mobile pop-up */}
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-50 lg:hidden">
