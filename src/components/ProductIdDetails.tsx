        ...
        <div className="details-id-wrapper">
          ...
          <div className="product-description">
            <div className="flex flex-col gap-[1em] py-[1.5em]">
              <h2 className="font-clash text-base font-normal text-[#2A254B]">Product Description</h2>
              <p className="font-satoshi font-normal text-[#2A254B] text-[1.em]">{product.productDescription?.main}</p>
            ...
            <div className="flex flex-col gap-[1em]">
              ...
              <div className="dimensions-group text-center">
                <div className="dimensions-item">
                  ...
                  <p className="font-satoshi text-sm font-normal text-[#2A254B]">{product.productDimensions?.height}</p>
                </div>

                <div className="dimensions-item">
                  <p className="font-clash text-sm font-normal text-[#2A254B]">Weight</p>
                  <p className="font-satoshi text-sm font-normal text-[#2A254B]">{product.productDimensions?.weight}</p>
                </div>

                <div className="dimensions-item">
                  <p className="font-clash text-sm font-normal text-[#2A254B]">Depth</p>
                  <p className="font-satoshi text-sm font-normal text-[#2A254B]">{product.productDimensions?.depth}</p>
                </div>
              </div>
